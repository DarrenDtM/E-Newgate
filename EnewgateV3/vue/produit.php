...
<html lang="en">
  <head>
    ...
    height: auto; /* gardez la hauteur proportionnelle pour éviter la distorsion */
    max-width: 100%;
  }
  .custom-card {
  width: 250px;
      ...
      <div class="row">
        ...
        <div class="col-sm-4 offset-md-1 py-4">
          ...
          <ul class="list-unstyled">
            <li><a href="loginView.php" class="text-white">Connexion</a></li>
    ...
    <div class="card shadow-sm custom-card">
      ...
      <div class="card-body">
        ...
        <div class="d-flex justify-content-between align-items-center">
          <div class="btn-group">
          <a href="details_produit.php?id=<?= $produit->id ?>" class="btn btn-sm btn-outline-secondary">Acheter</a>
          </div>
